...
function displayRealStatistics(real){
...
alert(real);
    ...
    type: "POST",
    url: "/statistics",
    data: real, // Data sent to server, a set of key/value pairs (i.e. form fields and values)
    processData: false,
    contentType:false,
    success: function(data)
    {
        $("span#real_ma").text(data["MedieAritmetica"]);
        $("span#real_mg").text(data["MedieGeometrica"]);
        $("span#real_mar").text(data["medieArmonica"]);
        $("span#real_amp").text(data["AbatereMediePatratica"]);
        $("span#real_aa").text(data["amplitudineAbsoluta"]);
        $("span#real_ar").text(data["AmplitudineRelativa"]);
        $("span#real_mp").text(data["MediePatratica"]);
        $("span#real_m").text(data["Mediana"]);
        $("span#real_cv").text(data["CoeficientVariatie"]);
        $("span#real_aml").text(data["AbatereMedieLiniara"]);
    },
    error: function (xhr, ajaxOptions, thrownError) {
        alert(xhr.status);
        alert(thrownError);
...
function displayPredictedStatistics(predicted){
    ...
    type: "POST",
    url: "/statistics",
    data: predicted, // Data sent to server, a set of key/value pairs (i.e. form fields and values)
    processData: false,
    contentType:false,
    success: function(data)
    {
        $("span#predict_ma").text(data["MedieAritmetica"]);
        $("span#predict_mg").text(data["MedieGeometrica"]);
        $("span#predict_mar").text(data["medieArmonica"]);
        $("span#predict_amp").text(data["AbatereMediePatratica"]);
        $("span#predict_aa").text(data["amplitudineAbsoluta"]);
        $("span#predict_ar").text(data["AmplitudineRelativa"]);
        $("span#predict_mp").text(data["MediePatratica"]);
        $("span#predict_m").text(data["Mediana"]);
        $("span#predict_cv").text(data["CoeficientVariatie"]);
        $("span#predict_aml").text(data["AbatereMedieLiniara"]);
    },
    error: function (xhr, ajaxOptions, thrownError) {
        alert(xhr.status);
        alert(thrownError);
...
displayRealStatistics(real);
displayPredictedStatistics(predict);
